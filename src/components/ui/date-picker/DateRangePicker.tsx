...
const iDateRangePickerVariants = cva(
  clsx(
    ...
    'transition-[box-shadow,border-color] duration-300 ease-in',
    '[&_.rc-picker-input]:h-full [&_.rc-picker-input]:min-w-[100px] [&_.rc-picker-input]:gap-2',
    ...
    '[&_input]:placeholder:text-gray-500 [&_input]:outline-none [&_input]:text-gray-800 [&_input]:min-w-[80px]',
    '[&_.rc-picker-range-separator]:flex [&_.rc-picker-range-separator]:items-center [&_.rc-picker-range-separator]:justify-center [&_.rc-picker-range-separator]:px-2 [&_.rc-picker-range-separator]:text-gray-400',
    '[&_.rc-picker-active-bar]:!hidden',
    '[&_.rc-picker-range-arrow]:!hidden',
    '[&_.rc-picker-input-active]:!bg-transparent',
    '[&_.rc-picker-input]:!bg-transparent',
  ...
  ),
  {
    variants: {
      ...
      variant: {
        default: clsx(
          '!border !border-gray-200 [&.rc-picker-focused]:!border-primary-500 [&.rc-picker-focused]:ring-2 [&.rc-picker-focused]:ring-primary-300',
        ),
...
type IDateRangePickerProp = VariantProps<typeof iDateRangePickerVariants> &
  Omit<RangePickerProps<Dayjs>, 'locale' | 'generateConfig' | 'value'> & {
...
const IDateRangePicker = forwardRef(
  (
    {
      className,
      dropdownClassName,
    ...
    const [_value, setValue] = useState<RangeValue>(value ?? null);
    ...
    const onChange = (
      ...
      setValue(newValue);
      if (onChangeValue) {
        onChangeValue?.(newValue, newString as [string, string]);
      }
    };
    ...
    return (
      <RangePicker<Dayjs>
        ...
        className={cn(
          iDateRangePickerVariants({ size, variant }),
          {
...
IDateRangePicker.displayName = 'IDateRangePicker';
